...
namespace SadWork
{
    partial class NewPark
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panelNewPark.Controls.Add(this.labelPDF);
            this.panelNewPark.Controls.Add(this.openFile);
            this.panelNewPark.Controls.Add(this.iconButtonReset);
            this.panelNewPark.Controls.Add(this.textBoxEmail);
            this.panelNewPark.Controls.Add(this.textBoxName);
            this.panelNewPark.Controls.Add(this.iconButtonAdd);
            this.panelNewPark.Controls.Add(this.panel2);
            this.panelNewPark.Controls.Add(this.textBoxBriefDesc);
            this.panelNewPark.Controls.Add(this.label6);
            this.panelNewPark.Controls.Add(this.label8);
            this.panelNewPark.Controls.Add(this.label4);
            this.panelNewPark.Controls.Add(this.label3);
            this.panelNewPark.Controls.Add(this.comboBoxArea);
            this.panelNewPark.Controls.Add(this.label2);
            ...
            this.iconButtonReset.IconChar = FontAwesome.Sharp.IconChar.Spinner;
